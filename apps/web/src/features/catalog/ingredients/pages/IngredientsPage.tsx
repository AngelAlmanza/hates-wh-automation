  ...
  return (
    <div className="relative">
      <div className="flex items-baseline justify-between mb-5">
        <h2 className="text-2xl font-black text-brand-dark">Ingredientes</h2>
      ...
      {!isLoading && !error && ingredients.length === 0 && (
        <div className="text-center py-20">
          ...
          <p className="font-bold text-brand-dark/50">Sin ingredientes aún</p>
      ...
      {!isLoading && ingredients.length > 0 && (
        <ul className="space-y-2.5">
          {ingredients.map((ingredient: Ingredient) => (
            ...
            >
              <div className="w-1.5 shrink-0 bg-stripe-ingredients" />
              <div className="flex items-center gap-3 flex-1 px-4 py-4">
                ...
                <div className="flex gap-1 shrink-0">
                  <button
                    onClick={() => navigate(`/catalog/ingredients/${ingredient.id}/edit`)}
